...
export const updateUser = asyncHandler(async (req: Request, res: Response) => {
  ...
  // Only profile fields are editable here: findByIdAndUpdate skips the
  // pre-save hook, so a password in the body would be stored unhashed, and
  // wallet balances must only change through the wallet ledger.
